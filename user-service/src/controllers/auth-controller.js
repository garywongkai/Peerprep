	...
	signInWithEmailAndPassword(auth, email, password)
		.then((userCredential) => {
			...
			if (idToken && uid) {
				...
				res.cookie("access_token", idToken, { httpOnly: false, sameSite: 'None', });
				res.cookie("uid", uid, { httpOnly: false, sameSite: 'None', });
				res.cookie("email", email, { httpOnly: false, sameSite: 'None', });
				res.cookie("displayName", displayName, { httpOnly: false, sameSite: 'None', });
				res.cookie("photoURL", photoURL, { httpOnly: false, sameSite: 'None', });
